...
import { LayoutDashboard, Upload, FileText, BarChart3, Settings, Zap, Bell, LogOut, User, Search, Menu } from "lucide-react";
...
const SidebarNav = ({ location }: { location: ReturnType<typeof useLocation> }) => (
